...
function page() {
    ...
    return (
        <>
            ...
            <div className="destination-page package-head-card pt-100 mb-100">
                <div className="container">
            ...
            <div className="destination-dt-travel-season-section mb-100" id="scroll-section">
                <div className="container">
                    ...
                    <div className="row g-4">
                        <div className="col-lg-4 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms" style={{ visibility: "visible", animationDuration: "1500ms", animationDelay: "200ms" }}>
                        ...
                        <div className="col-lg-4 wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms" style={{ visibility: "visible", animationDuration: "1500ms", animationDelay: "400ms" }}>
                            <div className="travel-season-card">
                                <div className="travel-season-top-area gap-3 position-relative">
                                    <div className="travel-season-img">
                        ...
                        <div className="col-lg-4 wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms" style={{ visibility: "visible", animationDuration: "1500ms", animationDelay: "600ms" }}>
                            <div className="travel-season-card">
                                <div className="travel-season-top-area gap-3 position-relative">
                                    <div className="travel-season-img">
